...
const TYPE_COLORS = {
  ...
  endpoint_latency_high: 'var(--red)',
  endpoint_packet_loss_high: 'var(--yellow)',
  endpoint_availability_low: 'var(--red)',
...
const THRESHOLD_LABELS = {
  ...
  endpoint_latency_high: '>300ms',
  endpoint_packet_loss_high: '>5%',
  endpoint_availability_low: '<95%',
    ...
    <div className="flex gap-2 h-full items-center px-2 overflow-hidden">
      {recent.map((a, i) => (
        ...
        >
          ...
          <span className="ml-1" style={{ color: 'var(--text)' }}>{a.node_id || a.endpoint_id}</span>
